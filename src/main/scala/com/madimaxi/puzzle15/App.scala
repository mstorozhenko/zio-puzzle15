...
import com.madimaxi.puzzle15.controller.{Start, State, Terminate}
...
//  }
  ...
  val program: ZIO[Has[Runner[Int]], Unit, State] = ZIO.iterate(Start: State)(_ != Terminate)(Runner.start[Int])
